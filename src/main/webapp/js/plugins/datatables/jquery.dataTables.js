...
(/** @lends <global> */function(window, document, undefined) {
	...
	(/** @lends <global> */function($) {
		...
		var DataTable = function(oInit) {
			...
			function _fnReloadAjaxfunction(oSettings, sNewSource, fnCallback, bStandingRedraw) {
			...
			function _fnFilterClear(oSettings) {
				var i, iLen;
		 ...
		 */
			...
			this.oApi = {
				...
				"_fnReloadAjax": _fnReloadAjaxfunction,
				"_fnFilterClear": _fnFilterClear
			};
