...
<%
	...
	String backPage = "javascript: history.back();";
	if (message == null) {
		// unknown length
		message = Validator.stripXSS(request.getParameter("message"));
		backPage = "/page/manager/dashboard.jsp";
	}
%>
<!DOCTYPE html>
...
<div class="actions">
	<div class="list-group">
		...
		<a href="/page/manager/dashboard.jsp" class="list-group-item"><i class="icon-home"></i><%=langMessage.get(
			"form.text.page.history.dashborad") %>
		</a>
		<a href="<%=backPage%>" class="list-group-item"><i class="icon-arrow-left"></i><%=langMessage.get(
