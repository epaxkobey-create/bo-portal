...
<head>
	...
	<script type="text/javascript" src="/js/plugins/bootstrap/bootstrap.min.js?v=<%=FrontendUtils.getJsFileVersion()%>"></script>
	...
	<div class="actions">
		<div class="list-group">
			<% for(Object obj : errors) { %>
				<li class="list-group-item list-group-header align-center"><%=obj%></li>
			<%}%>
			<a href="javascript: history.back();" class="list-group-item"><i class="icon-arrow-left"></i><%=langMessage.get("form.text.page.history.back") %></a>
		</div>
	</div>
